                ...
                sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"EDITCHARACTER"]) {
        ...
        SaveCharacterViewController* editVC = segue.destinationViewController;
        
        CharacterModel *characterEdit = cur[self.index];
        
        editVC.n
        
        editVC.IM = [UIImage imageNamed: character.image];
        editVC.
